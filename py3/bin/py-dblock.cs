...
** This File: /bisos/git/auth/bxRepos/bisos-pip/py-dblock/py3/bin/py-dblock.cs
...
***** [[elisp:(org-cycle)][| *CmndDesc:* | ]]  Conventional top level example.
        ...
        cmnd('updateDblocks',
             args='../tests/AI-WorkPlan.org',
             comment="# Expand the b:ai:file/particulars dblock in the example/test file")
        cmnd('updateDblocks',
